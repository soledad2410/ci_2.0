...
<div id="content">
			...
			<div class="box">
                ...
                <div class="save" >
                <a href="javascript:void(0)" onclick="delete_articlecomment();"><img src="html/resources/images/delete.png" width="32px" height="32px"/><br />
                <span>Xóa bình luận</span>
                </a>
                </div>
                <div class="save" >
                <a href="javascript:void(0)" onclick="active_articlecomment();"><img src="html/resources/images/apply.png" width="32px" height="32px"/><br />
                <span>Duyệt </span>
                </a>
                </div>
                <div class="save" >
                <a href="javascript:void(0)" onclick="deactive_articlecomment();"><img src="html/resources/images/icons/active_0.gif" width="30px" height="30px"/><br />
                <span>Bỏ duyệt</span>
                </a>
                </div>
					...
					<table>
                        ...
                        ?>
							...
							<tr>
								...
								<td class="price" style="width: 15%;color:red;"><a href="<?=base_url()?>admin/article/comment.html?article_id=<?=$comment['article_id']?>"><?=$comment['article_title']?></a></td>
                                ...
                                <td class="queu"><a href="admin/article/view_comment/<?=$comment['comment_id']?>.html"><img src="html/resources/images/icons/read_<?=$comment['comment_read']?>.png" width="16" height="16" alt="active"/></a></td>
