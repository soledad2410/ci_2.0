...
<div id="content">
			...
			<div class="box">
                ...
                <div class="save" >
                <a href="<?=base_url()?>admin/galleries/comment.html" ><img src="html/resources/images/icons/back.png" width="32px" height="32px"/><br />
                <span>Quay lại</span>
                </a>
                ...
                <div class="save" >
                <a href="javascript:void(0)" onclick="delete_albumcomment('<?=$comment['comment_id']?>');"><img src="html/resources/images/delete.png" width="32px" height="32px"/><br />
                <span>Xóa</span>
                </a>
                </div>
                <div class="save" >
                ...
                <div class="field">
                    ...
                    <div class="field">
                        ...
                        <div class="field">
							<div class="label">
								<label for="autocomplete">Album</label>
							</div>
							<div class="input">
								<strong><?= $comment['gallery_title'] ?></strong>
							</div>
				        </div>
                        <div class="field">
							<div class="label">
