...
<div id="content">
			...
			<div class="box">
                ...
                <div class="save">
                <a href="admin/product/cate.html#form" ><img src="html/resources/images/add.png" width="32px" height="32px"/>
                <span>Thêm </span>
                </a>
                </div>
                <div class="save" >
                <a href="javascript:void(0)" onclick="delete_cate_product();"><img src="html/resources/images/delete.png" width="32px" height="32px"/>
                <span>Xóa</span>
                </a>
                </div>
                <div class="save" >
                <a href="javascript:void(0)" onclick="edit_cate_product();"><img src="html/resources/images/edit.png" width="32px" height="32px"/>
                <span>Sửa</span>
                </a>
                </div>
                ...
                <div class="table">
					<form id="frm_list_cate_product" name="frm_list_cate_product">
					<table>
						<thead>
							<tr>
