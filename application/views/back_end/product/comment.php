...
<div id="content">
			...
			<div class="box">
                ...
                <div class="save" >
                <a href="javascript:void(0)" onclick="delete_productcomment();"><img src="html/resources/images/delete.png" width="32px" height="32px"/><br />
                <span>Xóa bình luận</span>
                </a>
                </div>
                <div class="save" >
                <a href="javascript:void(0)" onclick="active_productcomment();"><img src="html/resources/images/apply.png" width="32px" height="32px"/><br />
                <span>Hiển thị </span>
                </a>
                </div>
                <div class="save" >
                <a href="javascript:void(0)" onclick="deactive_productcomment();"><img src="html/resources/images/icons/active_0.gif" width="30px" height="30px"/><br />
                ...
                <div class="table">
					<form id="frm_list_productcomment" name="frm_list_productcomment">
					<table>
						<thead>
							<tr>
                        ...
                        ?>
							...
							<tr>
								...
								<td class="price" style="width: 15%;color:red;"><a href="<?=base_url()?>admin/product/comment.html?product_id=<?=$comment['product_id']?>"><?=$comment['product_name']?></a></td>
								<td class="date" id="dp1307331808406" style="color: red;"><?= datetime_vi($comment['comment_date']) ?></td>
                                ...
                                <td class="queu"><a href="admin/product/view_comment/<?=$comment['comment_id']?>.html"><img src="html/resources/images/icons/read_<?=$comment['comment_read']?>.png" width="16" height="16" alt="active"/></a></td>
