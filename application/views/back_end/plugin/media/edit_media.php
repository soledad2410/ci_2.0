...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    $("#media_publish").attr('value','<?= (trim($media['media_publish']=='')||($media['media_publish']=='0'))?'':date('d-m-Y',$media['media_publish'])?>');
    $("#media_expire").attr('value','<?= (trim($media['media_expire']=='')||($media['media_expire']=='0'))?'':date('d-m-Y',$media['media_expire'])?>');})
  ...
  <div class="box">
				<!-- box / title -->
				<div class="title">
					<h5>Sửa thông tin link liên kết</h5>
				</div>
                                   <?=$message?>
                    <div class="sub_menu">
			...
			<div class="form">
				...
				<div class="field">
                	<div class="label">
                       ...
                       <div class="field">
							<div class="label">
								<label for="autocomplete">File</label>
							</div>
							<div class="input">
                                ...
                                <div id="media_url-thumb"><img src="<?=$media['media_url']?>" height="70"/></div>
							</div>
						</div>
                        <div class="field">
							<div class="label">
							...
							<div class="input">
							<input type="text" name="thumbnail" id="thumbnail"  value="<?=$media['thumbnail']?>"  size="60" />
                            <input type="button" value="Chọn từ server" onclick="get_ck('thumbnail')"/>
                            <div id="thumbnail-thumb"><img src="<?=$media['thumbnail']?>" height="70"/></div>
							</div>
						</div>
                        <div class="field">
							<div class="label">
							...
							<div class="input">
							<input type="text" name="media_href" id="media_href" value="<?=$media['media_href'] ?>"  />
                        	</div>
						</div>
                        <div class="field">
							<div class="label">
							...
							<div class="input">
							<input type="text" name="media_width" id="media_width" value="<?=$media['media_width']?>" size="20"  />(đối với dạng flash)
							</div>
                        ...
                        <div class="field">
							...
							<div class="input">
							<input type="text" name="media_height" id="media_height" value="<?=$media['media_height']?>" size="20"  />(đối với dạng flash)
							</div>
                       	</div>
                        <div class="field">
							<div class="label">
							...
							<div class="input">
							<input type="text" name="media_publish" id="media_publish"   class="date" readonly="true" />
                        ...
                        <div class="field">
							...
							<div class="input">
							<input type="text" id="media_expire" name="media_expire"  class="date" readonly="true" />
                        ...
                        <div class="field">
							...
							<div class="input">
							<input type="checkbox" name="media_visible" value="1" <?=($media['media_visible']==1)?'checked="checked"':'';?> />
