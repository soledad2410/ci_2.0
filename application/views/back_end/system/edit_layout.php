...
<div class="box" >
				...
				<form id="frm_edit_layout" name="frm_edit_layout">
				<div class="form">
					<div class="fields">
                    ...
                    <div class="field">
							...
							<div class="input">
								<input type="text" readonly="true" name="layout_name" class="required_field" value="<?=$layout['layout_name']?>"  size="40"  />(*Trùng tên layout trong thư mục layout website)
							</div>
						</div>
				<div class="field">
							<div class="label">
							...
							<div class="input">
								<input type="text" id="layout_title" name="layout_title" class="required_field" value="<?=$layout['layout_title']?>"  size="40"  />
							</div>
						</div>
                        ...
                        <div class="field">
							...
							<div class="input">
								<input type="checkbox" id="layout_visible" value="1" <?if($layout['layout_visible']==1){echo'checked="checked"';} ?>name="layout_visible"/>
							</div>
						</div>
                ...
                <div class="save" >
                <a href="javascript:void(0)" onclick="save_edit_layout();"><img src="html/resources/images/apply.png" width="32px" height="32px"/>
                <span>Lưu</span>
                </a>
